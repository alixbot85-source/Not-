...
### اجرا روی ترموکس (اندروید)

راهنمای کامل و رفع خطاهای رایج: **[`docs/TERMUX.md`](docs/TERMUX.md)**

⚠️ توکن را فقط در `.env` بگذارید، هرگز در `.env.example` —
دومی داخل گیت commit می‌شود.
...
- `docs/TERMUX.md` — راهنمای اجرا روی اندروید/ترموکس
